...
namespace Library.Kernel.DataBaseHelper
{
    public class DBHelper
    {
        ...
        /// DataSet 查询
        /// </summary> 
        public static DataSet ExecuteDataSet<T>(string authorizeInfo,string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
        ...
        /// DataSet 查询
        /// </summary> 
        public static DataSet ExecuteDataSet(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo)) 
                throw new AuthorizeException(); 
        ...
        /// 增、删、改 执行
        /// </summary> 
        public static int ExecuteNonQuery<T>(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
        ...
        /// 增、删、改 执行
        /// </summary> 
        public static int ExecuteNonQuery(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
        ...
        /// 查询所返回的结果集中第一行的第一列
        /// </summary> 
        public static object ExecuteScalar<T>(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
        ...
        /// 查询所返回的结果集中第一行的第一列
        /// </summary> 
        public static object ExecuteScalar(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
        ...
        /// DataReader 查询
        /// </summary> 
        public static IDataReader ExecuteReader<T>(string authorizeInfo, string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
        ...
        /// DataReader 查询
        /// </summary> 
        public static IDataReader ExecuteReader(string authorizeInfo,string sql, bool isStoredProc = false, IList<DBParameter> parm = null, DbTransaction tran = null)
        {
            if (!Authorize.IsAuthorize(authorizeInfo))
                throw new AuthorizeException(); 
