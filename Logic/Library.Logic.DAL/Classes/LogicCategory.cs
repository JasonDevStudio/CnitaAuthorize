...
namespace Library.Logic.Classes
{
    public class LogicCategory
    {
        ...
        public ModelCategory CategoryDetail(out string resultMsg, string authorizeInfo, Int32 id)
        {
            resultMsg = string.Empty;
            var model = new ModelCategory();
            try
        ...
        /// <param name="id">ModelId 类别</param>
        /// <returns>ModelCategory</returns>
        public ModelCategory CategoryDetailByPid(out string resultMsg, string authorizeInfo, Int32 id, DateTime StartDate, DateTime EndDate)
        {
            resultMsg = string.Empty;
            var model = new ModelCategory();
            try
        ...
        /// <param name="id">ModelId 类别</param>
        /// <returns>ModelCategory</returns>
        public IList<ModelCategory> CategoryAll(out string resultMsg, string authorizeInfo, Int32 ParentCateg = 0, string IsNav = null)
        {
            resultMsg = string.Empty;
            IList<ModelCategory> list = new List<ModelCategory>();
            try
        ...
        /// 获取树形结构分类
        /// </summary> 
        public IList<ModelCategory> CategoryAllThree(out string resultMsg, string authorizeInfo, Int32 ParentCateg = 0)
        {
            resultMsg = string.Empty;
            IList<ModelCategory> list = new List<ModelCategory>();
            try
        ...
        public int CategoryInsertUpdate(out string resultMsg, string authorizeInfo, ModelCategory category, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
        ...
        /// <param name="id">Id 类别</param>
        /// <returns>执行结果</returns>
        public int CategoryDelete(out string resultMsg, string authorizeInfo, Int32 id, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
