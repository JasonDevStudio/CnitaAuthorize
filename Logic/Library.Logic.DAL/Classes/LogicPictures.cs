...
namespace Library.Logic.Classes
{
    public class LogicPictures 
    {
        ...
        public ModelPictures PicturesDetail(out string resultMsg, string authorizeInfo, Int32 id)
        {
            resultMsg = string.Empty;
            var model = new ModelPictures();
            try
        ...
        public IList<ModelPictures> QueryPicturesListByOwner(out string resultMsg, string authorizeInfo, string CategoryCode, string ownerCode)
        {
            resultMsg = string.Empty;
            var model = new ModelPictures();
            IList<ModelPictures> list = new List<ModelPictures>();
        ...
        public int PicturesInsertUpdate(out string resultMsg, string authorizeInfo, ModelPictures pictures, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
        ...
        /// <returns>执行结果</returns>
        public int PicturesUpdateStatus(out string resultMsg,string authorizeInfo,Int32 id ,Int32 status ,DbTransaction tran=null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
        ...
        /// <param name="id">Id 编号</param>
        /// <returns>执行结果</returns>
        public int PicturesDelete(out string resultMsg, string authorizeInfo, Int32 id, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
