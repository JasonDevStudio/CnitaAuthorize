...
namespace Library.Logic.DAL
{
    public class LogicArticle
    {
        ...
        public ModelArticle ArticleDetail(out string resultMsg, string authorizeInfo, int id)
        {
            resultMsg = string.Empty;
            var model = new ModelArticle();
            try
        ...
        /// <returns>ModelArticle</returns>
        public ModelArticle ArticleDetailByIsRecommend(out string resultMsg, string authorizeInfo, int categoryId)
        {
            resultMsg = string.Empty;
            var model = new ModelArticle();
            try
        ...
        public IList<ModelArticle> QueryArticleListTopByCategoryCode(out string resultMsg, out int CategIsAds, out string Introduction, out string Thumbnails, out string CategName, string authorizeInfo, string categoryCode = null, string categoryTwoCode = null, string adsCategoryCode = "33", int topCount = 5)
        {
            resultMsg = string.Empty;
            CategIsAds = 0;
            ...
            try
            {
                ...
                //查询执行
                using (DataSet ds = DBHelper.ExecuteDataSet(authorizeInfo, sql, true, parm))
                {
                    foreach (var item in parm)
                    {
                        //获取输出参数值
        ...
        public int ArticleInsertUpdate(out string resultMsg, string authorizeInfo, ModelArticle article, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
        ...
        /// <returns>执行结果</returns>
        public int ArticleUpdateStatus(out string resultMsg, string authorizeInfo, Int32 id, Int32 status, DbTransaction tran = null)
        {
            resultMsg = string.Empty;
            int res = 0;
            try
